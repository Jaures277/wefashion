...
@section('content')
    ...
    @section('title', 'En Solde')

    <section class="section">
        <div class="container">

            <div>
                <h4 class="section-title text-left">Produits en solde | {{ $nbre }} aticles </h4>
            </div>
                    ...
                    <div class="col-lg-4 mb-5">
                        <a class="card lift h-100" href="{{ route('detailProduit', $prod->id) }}">
                            ...
                            @if($prod->categoryId == 1)
                                <img height="350" width="450" class="card-img-top" src="{{asset('images/femmes/'.$prod->picture)}}" alt="{{ $prod->reference }}">
                            @endif

                            @if($prod->categoryId == 2)
                                <img height="350" width="450" class="card-img-top" src="{{asset('images/hommes/'.$prod->picture)}}" alt="{{ $prod->reference }}">
                            @endif
