...
@section('content')
    ...
    @section('title', 'Femmes')

    <section class="section">
                <div class="container">

                    <div>
                            <h4 class="section-title text-left">Produits Femmes | {{ $nbre }} aticles </h4>
                    </div>
                        ...
                        @foreach($listeProduit as $prod)
                            ...
                            <div class="col-lg-4 mb-5">
                                <a class="card lift h-100" href="{{ route('detailProduit', $prod->id) }}">
                                    ...
                                    <img class="card-img-top" height="450" width="350" src="{{asset('images/femmes/'.$prod->picture)}}" alt="{{ $prod->reference }}">
