<section class="section">
    <div class="container">
            ...
            <div>
                <h4 class="section-title text-left">Liste des produits </h4>
            </div>
                ...
                <div class="col-lg-4 mb-5">
                    <a class="card lift h-100" href="{{ route('detailProduit', $prod->id) }}">
                        ...
                        @if($prod->categoryId == 1)
                            <img height="450" width="350" class="card-img-top" src="{{asset('images/femmes/'.$prod->picture)}}" alt="{{ $prod->reference }}">
                        @endif
